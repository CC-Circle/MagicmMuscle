...
public class SerialPunch : MonoBehaviour
{
    
    private static SerialPunch instance;
    ...
    public  static float chargevalue = 0.4f;//チャージ開始閾値
    ...
    public void ReadData()
    {
        while (this.isLoop)
        {
            ...
            {
                strong = Mathf.Abs(value);
                UnityEngine.Debug.Log("受信: " + strong);
            }
